...
const names = ["Innovators Corp", "Tech Solutions Inc.", "FutureX Labs"];
  ...
  return (
    <section className="px-4 md:h-screen md:py-4 md:px-36 bg-slate-400 hero-section">
      ...
      <div className="max-w-[31rem] mt-28">
        <div className="my-4">
          <span className="mr-4 text-indigo-500">AI MEMBERSHIP</span>
        ...
        <p className="mb-8">
          Unlock the power of AI for your SaaS company with our comprehensive
          design and development subscription. Experience cutting-edge designs
          and advanced frontend solutions tailored for your needs, without the
          overhead of an internal team.
        </p>
        ...
        <div className="items-center gap-4 mt-6 md:flex">
          ...
          <div>
            <p className="text-slate-500">
              Trusted by leading innovators like:
            </p>
